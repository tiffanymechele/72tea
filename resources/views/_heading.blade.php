...
<nav class="bg-gray-800">
        ...
        <div class="flex justify-between md:h-16">
            <div class="flex">
                ...
                <div class="hidden md:ml-6 md:flex md:items-center md:space-x-4">
                    ...
                    <a href="{{ route('sale.create') }}" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">New Sale</a>
                    ...
                    <a href="{{ route('product.index') }}" class="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Edit Products</a>
    ...
    <div class="md:hidden" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
            <a href="{{ route('sale.create') }}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">New Sale</a>
            ...
            <a href="/ingredient/create"  class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">New Ingredient</a>

            <a href="/product/create" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">New Product</a>
...
{{--            <a href="/customers" class="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">Customers</a>--}}
            ...
            <a href="{{ route('product.index') }}" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Edit Products</a>
